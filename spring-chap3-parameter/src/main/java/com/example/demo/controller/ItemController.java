...
public class ItemController {
	...
	public String confirmDetail(
			...
			@RequestParam(name = "price", defaultValue = "") Integer price, //defaultValueが空文字列のためInteger
			@RequestParam(name = "categoryId", defaultValue = "") int categoryId,
			@RequestParam(name = "genre", defaultValue = "") String[] genreList,
			@RequestParam(name = "releaseDate", defaultValue = "") LocalDate releaseDate, //Localdateは日付型の一般的な型
			Model model) {
